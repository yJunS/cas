...
--%>
<jsp:directive.include file="includes/top1.jsp" />
...
<div class="box" id="login">
  <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
    ...
    <form:errors path="authenticationFailure.FailedLoginException" id="msg" cssClass="errors" element="div" htmlEscape="false" />
