...
public class User implements org.apache.thrift.TBase<User, User._Fields>, java.io.Serializable, Cloneable, Comparable<User> {
  ...
  private static final org.apache.thrift.protocol.TField PERSONID_FIELD_DESC = new org.apache.thrift.protocol.TField("personId",org.apache.thrift.protocol.TType.I32,(short)10);
  private static final org.apache.thrift.protocol.TField CREDENTIALSSALT_FIELD_DESC = new org.apache.thrift.protocol.TField("credentialsSalt", org.apache.thrift.protocol.TType.STRING, (short)11);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PERSONID((short)10, "personId"),
    CREDENTIALSSALT((short)11, "credentialsSalt");
  ...
  public void setPasswordIsSet(boolean value) {
   ...
   public void setCredentialsSalt(String credentialsSalt) {
    ...
    public void unsetCredentialsSalt() {
        this.credentialsSalt = null;
    }

    /** Returns true if field password is set (has been assigned a value) and false otherwise */
    public boolean isSetCredentialsSalt() {
        return this.credentialsSalt != null;
    }

    public void setCredentialsSaltIsSet(boolean value) {
        if (!value) {
            this.credentialsSalt = null;
        }
    }
    ...
    case CREDENTIALSSALT:
        if (value == null) {
            unsetCredentialsSalt();
        } else {
            setCredentialsSalt((String)value);
        }
        break;
    }
  }
  ...
  public boolean equals(User that) {
    ...
    boolean this_present_credentialsSalt = true && this.isSetCredentialsSalt();
    boolean that_present_credentialsSalt = true && that.isSetCredentialsSalt();
    if (this_present_credentialsSalt || that_present_credentialsSalt) {
      if (!(this_present_credentialsSalt && that_present_credentialsSalt))
          return false;
      if (!this.credentialsSalt.equals(that.credentialsSalt))
          return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_credentialsSalt = true && (isSetCredentialsSalt());
    list.add(present_credentialsSalt);
    if (present_credentialsSalt)
      list.add(credentialsSalt);
  ...
  public int compareTo(User other) {
    ...
    lastComparison = Boolean.valueOf(isSetCredentialsSalt()).compareTo(other.isSetCredentialsSalt());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCredentialsSalt()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.credentialsSalt, other.credentialsSalt);
      if (lastComparison != 0) {
          return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("credentialsSalt:");
    if (this.credentialsSalt == null) {
      sb.append("null");
    } else {
      sb.append(this.credentialsSalt);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class UserStandardScheme extends StandardScheme<User> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 10: // PERSONID
            ...
            break;
          case 11: // credentialsSalt
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.credentialsSalt = iprot.readString();
                struct.setCredentialsSaltIsSet(true);
            } else {
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, User struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(PERSONID_FIELD_DESC);
      oprot.writeI32(struct.personId);
      oprot.writeFieldEnd();
      if (struct.credentialsSalt != null) {
        oprot.writeFieldBegin(CREDENTIALSSALT_FIELD_DESC);
        oprot.writeString(struct.credentialsSalt);
        oprot.writeFieldEnd();
      }
  ...
  private static class UserTupleScheme extends TupleScheme<User> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, User struct) throws org.apache.thrift.TException {
      ...
      if(struct.isSetCredentialsSalt()){
        optionals.set(10);
      }
