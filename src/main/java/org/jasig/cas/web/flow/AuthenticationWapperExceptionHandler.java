 ...
 * 捕获的异常处理
 * @author dongtian
 * @date   2015年5月25日 下午2:13:41
 */
public class AuthenticationWapperExceptionHandler {
    ...
    static {
        ...
        DEFAULT_ERROR_LIST.add(org.jasig.cas.excption.FailedPasswordException.class);
        DEFAULT_ERROR_LIST.add(org.jasig.cas.excption.EmptyPasswordException.class);
        DEFAULT_ERROR_LIST.add(org.jasig.cas.excption.EmptyUserNameException.class);
        DEFAULT_ERROR_LIST.add(org.jasig.cas.excption.NotAvailableUserException.class);
    }
